...
```{r plot_avg_by_interval_baseplot, fig.height=4}
...
```{r plot_avg_by_interval_ggplot2, fig.height=4}
...
```{r plothist_na_fixed, fig.height=4}
...
```{r summary_steps_per_day_na_fixed}
...
```{r calculate_mean_median_na_fixed}
...
```{r plot_avg_by_interval_na_fixed_baseplot, fig.height=4}
#Making the plot
library(lattice)
...
```{r plot_avg_by_interval_na_fixed_ggplot2, fig.height=4}
